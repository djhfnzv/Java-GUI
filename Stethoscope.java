...
public class Stethoscope extends JFrame implements ActionListener
{
	...
	public Stethoscope(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/Stethoscope.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Stethoscope has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("3M Littmann Classic II Pediatric Stethoscope", "1" , "10000");
			c.setVisible(false);
			new Instrument();
		}
