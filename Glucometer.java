...
public class Glucometer extends JFrame implements ActionListener
{
	...
	public Glucometer(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/Glucometer.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Gluco Meter has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("1 Touch Prime Blood Gluco Meter", "1" , "2600");
			c.setVisible(false);
			new Instrument();
		}
