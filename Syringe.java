...
public class Syringe extends JFrame implements ActionListener
{
	...
	public Syringe(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/Syringe.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Syringe Set has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("Syringe Set", "1" , "700");
			c.setVisible(false);
			new Instrument();
		}
