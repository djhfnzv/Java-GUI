...
public class BpMachine extends JFrame implements ActionListener
{
	...
	public BpMachine(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/BpMachine.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "BP Mechine has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("Automatic Bp Mechine", "1" , "5000");
			c.setVisible(false);
			new Instrument();
		}
