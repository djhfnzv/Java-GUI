...
public class Thermometer extends JFrame implements ActionListener
{
	...
	public Thermometer(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/Thermometer.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Thermometer has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("Digital Thermometer", "1" , "150");
			c.setVisible(false);
			new Instrument();
		}
