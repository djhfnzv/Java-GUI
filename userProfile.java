...
{
	private JPanel p1;
	private JLabel bgL, l1, l2,l3,l4,l5,l6;
	private JButton medBtn,aboutusBtn,myprofileBtn,signoutBtn, exitBtn, prevBtn,nextBtn,cartBtn,homeBtn,p,medicineBtn,instrumentsBtn;
	...
	public userProfile()
	{
		...
		try{
			BufferedReader reader = new BufferedReader(new FileReader("Data File/User_registration_data.txt"));
            reader.close();
     
			line1 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(3);
			line2 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(5);
			line3 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(6);
			line4 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(7);
			line5 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(8);
			line6 = Files.readAllLines(Paths.get("Data File/User_registration_data.txt")).get(9);
