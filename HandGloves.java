...
public class HandGloves extends JFrame implements ActionListener
{
	...
	public HandGloves(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/HandGloves.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Hand Gloves has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("Surgical Hand Gloves", "1" , "400");
			c.setVisible(false);
			new Instrument();
		}
