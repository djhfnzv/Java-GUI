...
public class Bandage extends JFrame implements ActionListener
{
	...
	public Bandage(){
		...
		bgL = new JLabel(new ImageIcon(getClass().getResource("/Images/Bandage.png")));
 ...
 public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==homeBtn){
			...
			JOptionPane.showMessageDialog(this, "Bandage has been added to your cart","MedLife",-1);
			
			this.setVisible(false);
			Cart c = new Cart();
			c.addToCart("First Aid Bandage Combo", "1" , "300");
			c.setVisible(false);
			new Instrument();
		}
